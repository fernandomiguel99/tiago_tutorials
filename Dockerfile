...
RUN apt-get update && apt-get install -y --no-install-recommends \
  ...
  && wget https://raw.githubusercontent.com/fernandomiguel99/tiago_tutorials/kinetic-devel/hera_public-melodic.rosinstall \
  && vcs import src < hera_public-melodic.rosinstall
